      ...
      return (
        <div className="min-h-dvh flex items-center justify-center p-4 bg-muted">
          <div className="text-center space-y-4 max-w-sm">
            ...
            <h1 className="font-heading uppercase tracking-wide text-xl">Algo salió mal</h1>
            <p className="text-ink/60 text-sm">Ocurrió un error inesperado. Intenta de nuevo.</p>
            <button
