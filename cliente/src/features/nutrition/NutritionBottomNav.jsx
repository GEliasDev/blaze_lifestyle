...
// Persistent module nav, same on mobile and desktop (mirrors
// ExerciseBottomNav, including its always-visible desktop treatment):
// left = list, right = add entry. Icon-only, no text labels — aria-label
