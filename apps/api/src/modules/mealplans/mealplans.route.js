...
import { createPlanSchema, planItemSchema, patchItemSchema } from "./mealplans.schema.js";
...
coachPlansRouter.patch("/plan-items/:itemId", validate(patchItemSchema), mealplansController.updateItem);
